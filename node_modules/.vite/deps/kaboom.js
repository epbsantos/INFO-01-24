...
}, i(_a2, "Color"), __publicField(_a2, "RED", new _a2(255, 0, 0)), __publicField(_a2, "GREEN", new _a2(0, 255, 0)), __publicField(_a2, "BLUE", new _a2(0, 0, 255)), __publicField(_a2, "YELLOW", new _a2(255, 255, 0)), __publicField(_a2, "MAGENTA", new _a2(255, 0, 255)), __publicField(_a2, "CYAN", new _a2(0, 255, 255)), __publicField(_a2, "WHITE", new _a2(255, 255, 255)), __publicField(_a2, "BLACK", new _a2(0, 0, 0)), _a2);
function J(...n) {
  if (n.length === 0)
...
i(J, "rgb");
var vr = i((n, e, o) => W.fromHSL(n, e, o), "hsl2rgb");
var _a3;
var oe = (_a3 = class {
  constructor(e, o, c, g) {
    __publicField(this, "x", 0);
...
var Ne = (_a14 = class {
  ...
  numListeners(e) {
    var _a26;
    return ((_a26 = this.handlers[e]) == null ? void 0 : _a26.numListeners()) ?? 0;
  }
}, i(_a14, "EventHandler"), _a14);
function Wt(n, e) {
  if (n === e)
    return true;
...
var Br = i((n) => n instanceof Error ? n.message : String(n), "getErrorMessage");
var _a15;
var Yt = (_a15 = class {
...
var zi = Qn.reduce((n, e) => n + e.size, 0);
var Zr = 2048;
var Ki = Zr * 4 * zi;
var Yi = Zr * 6;
var Wi = `
...
var zo = i((n = {}) => {
  ...
  function It(t, r = {}) {
    ...
    a.loop = !!r.loop, a.detune.value = r.detune ?? 0, a.playbackRate.value = r.speed ?? 1, a.connect(f), a.onended = () => {
      var _a26;
      N() >= ((_a26 = a.buffer) == null ? void 0 : _a26.duration) && h.trigger();
    ...
    return { stop() {
      ...
      var _a26;
      ((_a26 = a.buffer) == null ? void 0 : _a26.duration) && (M > a.buffer.duration || (u ? (a = _(a), p = d - M) : (a.stop(), a = _(a), p = s.currentTime - M, a.start(0, M), w = true, d = 0)));
    }, set speed(M) {
      ...
      var _a26;
      return ((_a26 = a.buffer) == null ? void 0 : _a26.duration) ?? 0;
    }, time() {
    ...
    if (r instanceof Se || typeof r == "string") {
      ...
      for (let fe of a)
        if (!V.font.map[fe]) {
          ...
          V.outline && (U.lineJoin = "round", U.lineWidth = V.outline.width * 2, U.strokeStyle = V.outline.color.toHex(), U.strokeText(fe, V.outline.width, V.outline.width), B += V.outline.width * 2, F += V.outline.width * 3), U.fillText(fe, ((_a26 = V.outline) == null ? void 0 : _a26.width) ?? 0, ((_b = V.outline) == null ? void 0 : _b.width) ?? 0);
...
`)
  ...
  function Rs(t, r = {}) {
    function s(a) {
      ...
      return r.width || (a.width = h.width / (((_a26 = a.scale) == null ? void 0 : _a26.x) || 1)), a.height = h.height / (((_b = a.scale) == null ? void 0 : _b.y) || 1), h;
    }
    i(s, "update");
  ...
  function Qs(t, r) {
    ...
    let s = gt([qt(r.pos ?? T(0))]), u = t.length, a = 0, h = null, f = null, b = null, p = null, d = i((U) => U.x + U.y * a, "tile2Hash"), w = i((U) => T(Math.floor(U % a), Math.floor(U / a)), "hash2Tile"), A = i(() => {
      ...
      for (me.set(F, 0); ee.length !== 0; ) {
        let Fe = (_a26 = ee.remove()) == null ? void 0 : _a26.node;
        if (Fe === Y)
          break;
...
`));
    ...
    re.paused && Ce(() => {
      ...
      for (let u of C.logs) {
        ...
        a += `[time]${u.time.toFixed(2)}[/time]`, a += " ", a += `[${h}]${((_a26 = u.msg) == null ? void 0 : _a26.toString) ? u.msg.toString() : u.msg}[/${h}]`, r.push(a);
      }
